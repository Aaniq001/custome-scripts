...
scriptInjection("https://code.jquery.com/jquery-3.2.1.min.js", function () {
    ...
    var visitorCounterlib_vars_obj = {
        checkDevice: ''
    };

    /* Check if Mobile */
    if ($jq321.browser.mobile) {
        visitorCounterlib_vars_obj.checkDevice = 'mobile';
    } else {
        visitorCounterlib_vars_obj.checkDevice = 'desktop';
    }
    ...
    {
        if (visitorCounterlib_vars_obj.checkDevice == 'mobile')
        {
            $jq321("head").append(
                '<style type="text/css">' + 
                    '.visitor-counter-content-box-carecartbysalespop-2020{margin-top: -13px !important; margin-bottom: -8px !important;}' +
                '</style>');
        }
        else
        {
