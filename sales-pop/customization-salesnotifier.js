...
scriptInjection("https://code.jquery.com/jquery-3.2.1.min.js", function () {
    ...
    var salespoplib_vars_obj = {
        ...
        impressionURL: serverUrl.impressionURL
    };
    ...
    function timeCountdown(responseTimer) {
        ...
        if (responseTimer.above_cart == 1) {
            if (selectorTimer1.length == 1) {
                ...
                if(Shopify.shop == 'saadaa-design.myshopify.com'){
                    selectorTimer7.prepend(responseTimer.view);
                }else{
            ...
            if (selectorTimer1.length == 1) {
                ...
                if(Shopify.shop == 'saadaa-design.myshopify.com'){
                    selectorTimer7.append(responseTimer.view);
                }else{
