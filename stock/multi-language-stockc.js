...
scriptInjection("https://code.jquery.com/jquery-3.2.1.min.js", function () {
    ...
    if (Shopify.shop == "konstnarsportalen-se.myshopify.com")
    {
        finalSelector = masterSelector[0];
    ...
    if (Shopify.shop == "scholl-shoes-markets.myshopify.com")
    {
        finalSelector = masterSelector[0];
    ...
    function timeCountdown(t) {
        ...
        if (t.above_cart == 1)
        {
            ...
            {
                $jq321(t.view).insertBefore('.product-form__buttons');
            }
            else if (masterSelector.length > 0) 
            {
        ...
        {
            if (Shopify.shop == "togalway2.myshopify.com")
            {
                $jq321(t.view).insertAfter('.product-form__buttons');
            }
            else if (masterSelector.length > 0) 
            {
